    ...
    <footer className="bg-[#0F172A] text-slate-300 mt-auto">
      ...
      <div className="bg-gradient-to-r from-orange-600 to-orange-500">
        <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <a href="tel:+6281234567890" className="flex items-center gap-2 bg-white text-orange-600 font-bold px-5 py-2.5 rounded-lg hover:bg-orange-50 transition-colors">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-slate-400 leading-relaxed mb-4">
              Tim SAR dan relawan kemanusiaan yang berkomitmen memberikan pelayanan pencarian, pertolongan, evakuasi, serta penanggulangan bencana di Kecamatan Cikampek dan sekitarnya.
            </p>
            <div className="flex items-center gap-2">
              <Link href="#" aria-label="Facebook" className="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-800 hover:bg-orange-600 transition-colors">
                <Facebook className="h-4 w-4 text-white" />
              </Link>
              <Link href="#" aria-label="Instagram" className="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-800 hover:bg-orange-600 transition-colors">
                <Instagram className="h-4 w-4 text-white" />
              </Link>
              <Link href="#" aria-label="Youtube" className="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-800 hover:bg-orange-600 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-sm text-slate-400 hover:text-orange-500 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex gap-3">
                ...
                <span className="text-sm text-slate-400">Jl. Raya Cikampek No. 1, Cikampek, Karawang, Jawa Barat 41373</span>
              </li>
              <li className="flex gap-3">
              ...
              <li className="flex gap-3">
                ...
                <span className="text-sm text-slate-400">info@katanarescue.cikampek.id</span>
              </li>
              <li className="flex gap-3">
        ...
        <div className="mt-10 pt-6 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-xs text-slate-500">
            &copy; {new Date().getFullYear()} KATANA RESCUE. Portal Resmi Tim SAR dan Relawan Penanggulangan Bencana Kecamatan Cikampek. Hak Cipta Dilindungi.
          </p>
