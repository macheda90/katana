...
import { Shield, Users, Award, Activity, HeartHandshake, ArrowRight, Phone } from "lucide-react"
      ...
      <div className="container mx-auto px-4 relative z-10 py-20">
        <div className="max-w-3xl">
          ...
          <p className="text-base sm:text-lg text-slate-300 leading-relaxed mb-8 max-w-2xl">
            Katana Rescue adalah tim SAR dan relawan kemanusiaan yang berkomitmen
            memberikan pelayanan pencarian, pertolongan, evakuasi, serta
            penanggulangan bencana di wilayah Kecamatan Cikampek dan sekitarnya.
          </p>
